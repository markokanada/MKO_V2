...
$id = mysqli_real_escape_string($conn, $id);
    ...
    $groupQuery = "SELECT rendelesnev FROM rendelestervek WHERE id = '${id}'";
    ...
    $sql = "SELECT * FROM rendelestermekek WHERE username = '${user}' AND rendelesterv_nev = '${groupName}'";


$result = mysqli_query($conn, $sql);

if ($result === false) {
    die("Orderplan books query execution failed: " . mysqli_error($conn));
}
